...
<head>
  ...
  <title>Computerized Telecommunication; The Open Systems Interconnection Model</title>
  <style>
    :root {
      --bg: #0f1115;
      --card: #151923;
    ...
    body {
      ...
      color: var(--text);
      background: linear-gradient(180deg, #0b0d12, #0f1115 140px) fixed;
    }
    .container {
      max-width: 900px;
      margin: 0 auto;
    ...
    h1 { font-size: clamp(1.8rem, 2.4vw + 1rem, 2.6rem); letter-spacing: .3px; }
    h2 { font-size: clamp(1.3rem, 1.2vw + .9rem, 1.7rem); margin-top: 2.2rem; padding-top: .6rem; border-top: 1px solid var(--border); }
    h3 { font-size: 1.15rem; margin-top: 1.4rem; }
    p { margin: .85rem 0; }
    .muted { color: var(--muted); }
    .title-block { margin-bottom: 1.25rem; }
    .title-block .meta { margin-top: .6rem; font-size: .975rem; }
    .pill {
      display: inline-block; padding: .2rem .6rem; border-radius: 999px; border: 1px solid var(--border); background: #0f1422; color: var(--muted); font-size: .85rem;
    }
    nav.toc { background: #101522; border: 1px solid var(--border); border-radius: 12px; padding: 1rem; margin: 1rem 0 2rem; }
    nav.toc strong { display: block; margin-bottom: .25rem; color: var(--accent); }
    nav.toc a { color: var(--muted); text-decoration: none; }
    nav.toc a:hover { color: var(--accent-2); }
    nav.toc ol { margin: .3rem 0 0 1.2rem; }
    code, .kbd { font-family: ui-monospace, SFMono-Regular, Menlo, Consolas, "Liberation Mono", monospace; background: #0d111c; border: 1px solid var(--border); padding: .1rem .35rem; border-radius: 6px; }
    .callout { border-left: 3px solid var(--accent); background: #10182a; padding: .75rem 1rem; border-radius: 8px; }
    .footer { margin-top: 2.5rem; font-size: .95rem; color: var(--muted); }
